...
class studentClass:
    def __init__(self,root):
        ...
        lbl_addmission= Label(self.root,text = "Admission Date",font = ("goudy old style",15,'bold'),bg = 'white').place(x=360,y=140)
        lbl_course= Label(self.root,text = "Course",font = ("goudy old style",15,'bold'),bg = 'white').place(x=360,y=180)
        
        # Entry Fields Column 2
        Entry(self.root,textvariable = self.var_dob,font = ("goudy old style",15,'bold'),bg = 'lightyellow').place(x=540,y=60,width=140)
        Entry(self.root,textvariable = self.var_contact,font = ("goudy old style",15,'bold'),bg ='lightyellow').place(x=540,y=100,width=140)
        Entry(self.root,textvariable = self.var_a_date,font = ("goudy old style",15,'bold'),bg = 'lightyellow').place(x=540,y=140,width=140)
        ...
        self.txt_course.place(x=540,y=180,width=140)
    ...
    def delete(self):
        ...
        cur=con.cursor()
        try:
            if self.var_roll.get()=="" or self.txt_roll.cget('state') != 'readonly':
    ...
    def add(self):
        ...
        cur=con.cursor()
        try:
            if self.var_roll.get()=="" or self.var_name.get()=="" or self.var_course.get()=="Select":
                messagebox.showerror("Error","Roll No., Name and Course are required",parent=self.root)
            else:
    ...
    def show(self):
        ...
        try:
            ...
            messagebox.showerror("Error",f"Error showing data: {str(ex)}")
